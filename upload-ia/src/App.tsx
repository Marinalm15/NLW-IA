        ...
        <main className="flex-1 p-6 flex gap-6">
          <div className="flex flex-col flex-1 gap-4">
            <div className="grid grid-rows-2 gap-4 flex-1">
              <Textarea 
              className="rezise-none p-4 leading-relaxed resize-none"
            ...
            <p className="text-sm text-muted-foreground">Lembre-se: você pode utilizar a variável <code className="text-violet-400">{`{transcription}`}</code> no seu prompt para adicionar a transcrição do vídeo selecionado</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Select disabled defaultValue="gpt3.5">
                  ...
                  <SelectContent>
                    <SelectItem value={"gpt3.5"}>GPT 3.5-turbo16k</SelectItem>
                  </SelectContent>
                </Select>
